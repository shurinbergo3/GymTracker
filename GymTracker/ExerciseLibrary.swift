...
struct ExerciseLibrary {
    static let allExercises: [LibraryExercise] = [
        ...
        LibraryExercise(
            ...
            category: .legs,
            muscleGroup: .quadriceps,
            technique: "Расположи штангу на задних дельтах (ниже шеи). Хват чуть шире плеч, лопатки жестко сведены. На вдохе отведи таз назад и вниз, наклоняя корпус вперед, но не 'клюя' носом. Колени смотрят в сторону носков. Опускайся чуть ниже параллели бедра с полом. На выдохе мощно вставай, давя пятками в пол и удерживая спину прямой."
        ),
        LibraryExercise(
